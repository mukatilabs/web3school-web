            ...
            <div className="tab-content mt-50" id="myTabContent-1">
                <div  className={`tab-pane fade ${active == 1 && "show active"}`}>
                    <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                ...
                                <div className="card-block-info">
                                    <h5>
                                        <Link legacyBehavior href="/web3-blockchain-masterclass"><a>Web3.0 & Blockchain Masterclass</a></Link>
                                        </h5>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 grid-bd-16 hover-up">
                                <div className="card-grid-2-image"><span className="lbl-hot"><span>Intermidiate</span></span>
                                    <div className="image-box">
                                        <figure><img src="assets/imgs/page/homepage2/img2.png" alt="Hyperledger Fabric" /></figure>
                                    </div>
                                </div>
                                <div className="card-block-info">
                                    <h5>
                                        <Link legacyBehavior href="/job-details"><a>Hyperledger Fabric MasterClass</a></Link>
                                        </h5>
                                    <div className="mt-5"><span className="card-location mr-15">Live Session</span><span className="card-time">2 Days</span></div>
                                    <div className="card-2-bottom mt-20">
                                        <div className="row">
                                            <div className="col-xl-7 col-md-7 mb-2">
